    ...
    for num_transforms in range(init_transforms, max_transforms + 1):
        ...
        def objective_function(params_vector):
            ...
            try:
                ...
                result = SINDY_delays_MI(  # noqa: F405
                    shape_factors,
                    scale_factors,
                    loc_factors,
                    system_data.index,
        ...
        # Final evaluation
        final_model = SINDY_delays_MI(  # noqa: F405
            shape_factors,
            scale_factors,
            loc_factors,
            system_data.index,
        ...
        if (
            ...
            print(
                f"Last transformation added less than {early_stopping_threshold*100}% to R² score. Terminating early."
            )
            break
